...
process.env.VITE_ENV_TEST = "js overwrite";
...
// const DEV_INDEX_PATH = join(process.cwd(), "../../../", "oaysus-vite");
// const PROD_INDEX_PATH = join(process.cwd(), "../../../", "oaysus-vite", "dist");
console.log({ DEV_INDEX_PATH });
